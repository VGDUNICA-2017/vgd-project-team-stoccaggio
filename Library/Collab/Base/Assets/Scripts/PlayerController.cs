...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*if(PlayerPrefs.GetString("Scena") != null && PlayerPrefs.GetFloat("x") != 0 && PlayerPrefs.GetFloat("y") != 0 && PlayerPrefs.GetFloat("z") != 0)
        {            
            tr.position = new Vector3(PlayerPrefs.GetFloat("x"), PlayerPrefs.GetFloat("y"), PlayerPrefs.GetFloat("z"));
        }*/
    }
